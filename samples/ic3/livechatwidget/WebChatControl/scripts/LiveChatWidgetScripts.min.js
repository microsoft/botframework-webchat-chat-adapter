            ...
            (t.getStoreKey = function (t, i) {
              ...
              return (
                i & n.DataContextType.EnvironmentContext &&
                  ...
                  !n.Util.isNullOrUndefined(u) && u.length > 0 && (r += u + n.Constants.WidgetDataStoreKeySeparator)),
                i & n.DataContextType.OrganizationContext &&
                  ((f = n.Bootstrapper.orgId),
                  !n.Util.isNullOrUndefined(f) && f.length > 0 && (r += f + n.Constants.WidgetDataStoreKeySeparator)),
                i & n.DataContextType.WidgetContext &&
                  ((e = n.Bootstrapper.widgetId),
                  !n.Util.isNullOrUndefined(e) && e.length > 0 && (r += e + n.Constants.WidgetDataStoreKeySeparator)),
                r + t
              );
            }),
      ...
      (function (n) {
        ...
        (function (n) {
          ...
          (function (n) {
            ...
            n.AuthenticationToken = 'AuthenticationToken';
          ...
          (function (n) {
            ...
            n[(n.Closed = 2)] = 'Closed';
            n[(n.PopOutWindow = 3)] = 'PopOutWindow';
      ...
      (function (n) {
        ...
        a = (function () {
          ...
          return (
            ...
            (n.LCWCloseChatEvent = 'lcw:closeChat'),
            (n.LCWThreadUpdateEvent = 'lcw:threadUpdate'),
            (n.LCWErrorEvent = 'lcw:error'),
            (n.LCWChangeTitle = 'changeTitle'),
            n
          );
        })();
        n.LCWEvents = a;
        ...
        b = (function () {
          ...
          return (
            ...
            (n.popoutAuthTokenRequest = 'popoutAuthTokenRequest'),
            (n.popoutAuthTokenResponse = 'popoutAuthTokenResponse'),
            n
          );
        })();
        n.IframeMessages = b;
      ...
      (function (n) {
        var f = (function () {
            ...
            return (
              ...
              (t.DisableTelemetryAttributeName = 'data-disable-telemetry'),
              ...
              (t.OpenChatInPopOutWindowAttributeName = 'data-open-in-window'),
              (t.SrcUrlAttributeName = 'src'),
              (t.IdAttributeName = 'id'),
              ...
              (t.WidgetColorOverride = 'data-color-override'),
              ...
              (t.URLDelimiter = '&'),
              (t.EndURLSeparator = '?'),
              (t.ChatHTMLPath = '/htmls/chat.html'),
              (t.Equal = '='),
              ...
              (t.SpanAttributeName = 'span'),
              (t.CustomerDisplayName = 'Customer'),
              (t.DefaultUserId = 'teamsvisitor'),
              (t.msfpEmbedScript =
                '<script src="https://mfpembedcdnwus2.azureedge.net/mfpembedcontwus2/Embed.js" type="text/javascript"></script><link rel="stylesheet" type="text/css" href="https://mfpembedcdnwus2.azureedge.net/mfpembedcontwus2/Embed.css" /><script type = "text/javascript" >function renderSurvey(parentElementId,FirstName, LastName, locale,requestId){var se = new SurveyEmbed("##SurveyIdentifier##","https://forms.office.com/","https://mfpembedcdnwus2.azureedge.net/mfpembedcontwus2/","true");var context = {"First Name": FirstName,"Last Name": LastName,"locale": locale, "requestId":requestId, "showmultilingual":"false"};se.renderInline(parentElementId, context);}</script>'),
              (t.postChatSurveyIdentifierPlacement = '##SurveyIdentifier##'),
              (t.formsProEmbedSurveyLoadTime = 300),
              (t.postChatRenderTimeOnThreadUpdate = 500),
              (t.invalidMsfpEmbedScriptException = 'invalid msfpEmbedScript value'),
              ...
              (t.ChatButtonInitStyle =
                ...
                (f.rightString = 'right'),
                (f.position = 'fixed'),
                (f.bottomPosition = '0px'),
                (f.leftPosition = '0px'),
                (f.rightPosition = '0px'),
                (f.bottomLeftPosition = 'BottomLeft'),
                (f.bottomRightPosition = 'BottomRight'),
                (f.cursor = 'pointer'),
                f)),
              (t.HTMLConstants =
                ((i = (function () {
                ...
                (i.block = 'block'),
                (i.star = 'star'),
                (i.selectOnMouseDown = 'onmousedown'),
                (i.selectOnChange = 'onchange'),
                (i.selectOnBlur = 'onblur'),
                (i.selectSize = 'size'),
                (i.preChatMaxDropdownSize = '10'),
                i)),
              (t.IFrameConstants =
                ((e = (function () {
                  function n() {}
                ...
                (e.frameEdgeBuffer = 5),
                e)),
              (t.PopOutChatConstants =
                ((h = (function () {
                  function n() {}
                  return n;
                })()),
                (h.isPopOutModeAttributeName = 'is-popout-mode'),
                (h.isPopOutModeAttributeValue = 'true'),
                (h.target = 'Omnichannel Chat'),
                (h.location = 0),
                h)),
              (t.AttachmentIconStyle =
                ...
                (o.imagePadding = '8px 0 2px 8px'),
                (o.RTLDefaultPadding = '0 10px 0 0'),
                (o.RTLImagePadding = '8px 8px 2px 0'),
                o)),
              (t.applicationMicrosoftCard = 'application/vnd.microsoft.card'),
        ...
        u = (function () {
          function n() {}
          return (n.Embed = '192350000'), (n.Link = '192350001'), n;
        })();
        n.MSFPSurveyMode = u;
      })((t = n.LiveChatWidget || (n.LiveChatWidget = {})));
    })((t = n.Omnichannel || (n.Omnichannel = {})));
      ...
      (function (n) {
        var t = (function () {
          ...
          return (
                    ...
                    switch (s.label) {
                      case 0:
                        ...
                        return u && ((e = u[f[f.length - 1]]), e)
                          ...
                          ? [
                              4,
                              t.getAuthTokenOrAuthMethodFromOuterScope(
                                window.parent,
                                n.IframeMessages.authTokenRequest,
                                i
                              )
                            ]
                          : [3, 2];
            ...
            (t.getAuthTokenOrAuthMethodFromOuterScope = function (t, i, r) {
              return __awaiter(this, void 0, void 0, function () {
                var u, f, o, e, s;
                  ...
                  switch (h.label) {
                    case 0:
                      return (
                        ...
                        (e = function (t) {
                          t.data && t.data.messageName == n.IframeMessages.authTokenResponse
                            ? ((u = function (n) {
                                n(t.data.authToken);
                              }),
                              f())
                            : t.data &&
                              t.data.messageName == n.IframeMessages.popoutAuthTokenResponse &&
                              ((u = t.data.authToken), f());
                        }),
                        window.addEventListener('message', e, !1),
                        (s = { messageName: i, functionFullName: r }),
                        t.postMessage(s, '*'),
                        [4, o]
                      );
                    case 1:
                      return h.sent(), window.removeEventListener('message', e, !1), [2, u];
                  }
                });
              });
            }),
            ...
            (t.getPopOutWindowCssResources = function () {
              return [{ path: n.ScriptPaths.LiveChatPopOutWindowStylePath, resourceType: n.ResourceType.StyleSheet }];
            }),
      ...
      (function (n) {
        var t = (function () {
          ...
          return (
            ...
            Object.defineProperty(t, 'LiveChatPopOutWindowStylePath', {
              get: function () {
                return this.addStyleRoot(t.cssPathWithValidExtension(t.LiveChatPopOutWindowStyle));
              },
              enumerable: !0,
              configurable: !0
            }),
            ...
            (t.LiveChatPopOutWindowStyle = 'PopOutWindow.min.css'),
          ...
          return (
            ...
            (i.prototype.initialize = function (n) {
              ...
              t.Util.isNullOrUndefined(r)
                ...
                : ((h = r.getAttribute(t.Constants.AppIdAttributeName)),
                  (h && h.trim().length !== 0) ||
                    t.TelemetryClient.error({
                      Event: t.TelemetryEvent.BootscriptFormatInvalid,
                      CloudType: i.environmentVersion,
                  ...
                  (i.widgetId = h),
                  (c = r.getAttribute(t.Constants.OrgIdAttributeName)),
                  (c && c.trim().length !== 0) ||
                    t.TelemetryClient.error({
                      Event: t.TelemetryEvent.BootscriptFormatInvalid,
                      CloudType: i.environmentVersion,
                  ...
                  (i.orgId = c),
                  (l = r.getAttribute(t.Constants.OrgUrlAttributeName)),
                  (l && l.trim().length !== 0) ||
                    t.TelemetryClient.error({
                      Event: t.TelemetryEvent.BootscriptFormatInvalid,
                      CloudType: i.environmentVersion,
                  ...
                  (i.orgUrl = l),
                  (a = r.getAttribute(t.Constants.HostNameAttributeName)),
                  (a && a.trim().length !== 0) ||
                    t.TelemetryClient.error({
                      Event: t.TelemetryEvent.BootscriptFormatInvalid,
                      CloudType: i.environmentVersion,
                  ...
                  (i.hostName = a),
                  (u = r.getAttribute(t.Constants.DisableTelemetryAttributeName)),
                  (u && u.trim().length !== 0) || (u = 'false'),
                  (i.disableTelemetry = u.trim().toLowerCase() === 'true'),
                  ...
                  (v = r.getAttribute(t.Constants.WidgetColorOverride)),
                  v && v.trim().length !== 0 && (i.widgetThemeColor = v),
                  (o = r.getAttribute(t.Constants.OpenChatInPopOutWindowAttributeName)),
                  (o && o.trim().length !== 0) || (o = 'false'),
                  (i.openChatInPopOutWindow = o.trim().toLowerCase() === 'true'),
                  (y = r.getAttribute(t.Constants.SrcUrlAttributeName)),
                  (y && y.trim().length !== 0) ||
                    t.TelemetryClient.error({
                      Event: t.TelemetryEvent.BootscriptFormatInvalid,
                      CloudType: i.environmentVersion,
                      ExceptionDetails: { ErrorDetails: 'srcUrl Invalid' }
                    }),
                  (i.srcUrl = y),
                  (s = r.getAttribute(t.Constants.PopOutChatConstants.isPopOutModeAttributeName)),
                  (s && s.trim().length !== 0) || (s = 'false'),
                  (i.isPopOutMode = s.trim().toLowerCase() === 'true'),
                  i.isPopOutMode && this.loadPopOutWindowCSS(),
                  t.ConfigurationManager.initialize()
                    .then(function () {
                      return p.loadLibraries();
                    })
                    .catch(function (n) {
            ...
            (i.prototype.loadPopOutWindowCSS = function () {
              var n = [];
              n = n.concat(t.Util.getPopOutWindowCssResources());
            ...
            (i.prototype.loadLibraries = function () {
              ...
              n = n.concat([
                ...
                {
                  path:
                    // 'https://octestoccobranamgs.blob.core.windows.net/ersuodev/livechatwidget/WebChatControl/scripts/botframework-webchat-adapter-ic3.development.js',
                    '/dist/chat-adapter.js',
                  resourceType: t.ResourceType.Script
                },
                {
      ...
      (function (n) {
        ...
        (function (n) {
          ...
          (function (n) {
            ...
            n.PostChatFormsProRenderFailed = 'PostChatFormsProRenderFailed';
            ...
            n.IC3ThreadUpdateEvent = 'ThreadEventReceived';
      ...
      (function (n) {
        var t = (function () {
          ...
          return (
            ...
            Object.defineProperty(t, 'popOutWindowWidthScaleFactor', {
              get: function () {
                return t.configuration.popOutWindowWidthScaleFactor;
              },
              enumerable: !0,
              configurable: !0
            }),
            Object.defineProperty(t, 'popOutWindowHeightScaleFactor', {
              get: function () {
                return t.configuration.popOutWindowHeightScaleFactor;
              },
              enumerable: !0,
              configurable: !0
            }),
            (t.defaultConfiguration = {
              ...
              omnichannelSdkVersion: '2020.04.08.1',
              webChatSdkVersion: '4.8.0',
              webChatIC3AdapterVersion: '0.1.0-master.a1b69c0',
              ic3ClientVersion: '2020.04.07.1',
              useWebChat: !1,
              useCachedConfig: !1,
              swcPlatformId: '937',
              ...
              popOutWindowWidthScaleFactor: 0.3,
              popOutWindowHeightScaleFactor: 0.7,
              webChatStyles: {
                rootHeight: '84.8%',
          ...
          return (
            ...
            (i.prototype.getLiveChatConfig = function () {
              ...
              return new Promise(function (r, u) {
                var f = t.ContextSpecificDataStore.GetData(
                    t.DataContextType.WidgetContext | t.DataContextType.OrganizationContext,
                    t.WidgetDataKeys.ConfigData
                  ),
                  e,
                  o;
                if (t.ConfigurationManager.UseCachedConfig && !t.Util.isNullOrUndefined(f)) {
                  t.Bootstrapper.widgetThemeColor
                    ? ((f.chatButtonColor = t.Bootstrapper.widgetThemeColor),
                      (f.bubbleColor = t.Bootstrapper.widgetThemeColor),
                      (f.chatTitleColor = t.Bootstrapper.widgetThemeColor))
                    : (t.Bootstrapper.widgetThemeColor = f.chatButtonColor);
                  r(f);
                  return;
                }
                e = n.Omnichannel.LiveChatWidget.Util.newGuid();
                t.Bootstrapper.debugInfo.addConfigRequestId(e);
                o = t.Util.timer();
                t.OmnichannelProxy.getInstance()
                  .getChatConfiguration(e)
                  .then(function (n) {
            ...
            (i.prototype.transformConfig = function (n) {
              ...
              return (
                ...
                (i.bubbleColor = this.getWidgetThemeColor(
                  t.Constants.OptionSetMapping,
                  n.LiveWSAndLiveChatEngJoin.msdyn_widgetthemecolor
                )),
                (i.chatButtonColor = this.getWidgetThemeColor(
                  t.Constants.OptionSetMapping,
                  n.LiveWSAndLiveChatEngJoin.msdyn_widgetthemecolor
                )),
                ...
                (i.chatTitleColor = this.getWidgetThemeColor(
                  t.Constants.OptionSetMapping,
                  n.LiveWSAndLiveChatEngJoin.msdyn_widgetthemecolor
                )),
                ...
                (i.isPostChatEnabled =
                  n.LiveWSAndLiveChatEngJoin.msdyn_postconversationsurveyenable === 'true' ||
                  n.LiveWSAndLiveChatEngJoin.msdyn_postconversationsurveyenable === !0),
                (i.postChatSurveyMode = n.LiveWSAndLiveChatEngJoin.msdyn_postconversationsurveymode),
                (i.postChatSurveyIdentifier = n.LiveWSAndLiveChatEngJoin.msdyn_postconversationsurveyidentifier),
            ...
            (i.prototype.getWidgetThemeColor = function (n, i) {
              return (
                t.Bootstrapper.widgetThemeColor || (t.Bootstrapper.widgetThemeColor = this.getValue(n, i)),
                t.Bootstrapper.widgetThemeColor
              );
            }),
              ...
              return new Promise(function (u, f) {
                r.proxy
                  ? r.proxy
                      ...
                      .catch(function (n) {
                        t.Util.isNullOrUndefined(n) ||
                        n.response.headers.errorcode !== t.OmnichannelErrorCodes.WidgetUseOutsideOperatingHour
                          ? f(n)
          ...
          return (
            ...
            (i.prototype.getActionIcon = function (t) {
              ...
              return React.createElement(
                ...
                React.createElement(n.ToolTip, { targetId: t.id, delayHide: 500 }),
                React.createElement(
                  'button',
                  {
                    id: t.id,
        ...
        var t = (function (t) {
          ...
          return (
                      ...
                      'button',
                      {
                        ...
                        style: {
                          ...
                          backgroundColor: this.state.disableSendButton
                            ...
                            : n.Bootstrapper.widgetThemeColor,
            ...
            (i.prototype.sendEmailRequest = function (t, i, r) {
              ...
              var u = n.Loader.currentConversation.token.skypeToken;
              return n.OmnichannelProxy.getInstance()
        ...
        var i = (function (i) {
          ...
          return (
            ...
            (r.prototype.closeCallingDialog = function () {
              if (t.FeaturesManager.shouldEnableCallingAsEscalateChannel()) {
                var i = document.getElementById(t.HtmlIdNames.callingContainer),
                  n = document.createElement(t.Constants.SpanAttributeName),
                  r = 'endedcall';
                n.setAttribute(t.Constants.IdAttributeName, r);
                n.textContent = this.props.locale.END_CALL_MESSAGE;
                i.appendChild(n);
                this.refreshVoiceVideoCallDialog(!1, !1, !1, !1, !1, !1, !1);
                setTimeout(function () {
                  i.removeChild(document.getElementById(r));
                }, 1);
              }
            }),
            ...
            (r.prototype.render = function () {
              return React.createElement(
                'div',
                {
                  id: t.HtmlIdNames.callingContainer,
                  className: t.HtmlClassNames.callingContainer,
                  'aria-live': t.HtmlClassNames.assertive
                },
          ...
          function r(n) {
            ...
            return (
              ...
              (r.state = {
                ...
                isRefresh: !1,
                startProactiveChat: r.startProactiveChat.bind(r),
                handleChatButtonClick: r.handleChatButtonClick.bind(r),
                closeSession: r.closeSession.bind(r),
                unreadMessagesCount: 0,
                handleAgentEndConversation: r.handleAgentEndConversation.bind(r),
                showEmailRequestDialog: !1,
                showEmailCloseConfirmation: !1
              }),
              (r.enabledActions = r.getEnabledActions()),
              r
            );
          }
          return (
                  ...
                  switch (n.label) {
                    case 0:
                      if (
                        ...
                        try {
                          this.postchatController.addEmbedPostChatScriptToHead();
                        } catch (i) {
                          this.props.liveChatConfig.isPostChatEnabled = !1;
                          t.TelemetryClient.error({
                            Event: t.TelemetryEvent.PostChatFormsProRenderFailed,
                            ExceptionDetails: i
                          });
                        }
                      return (
            ...
            (r.prototype.componentDidUpdate = function (n, i) {
              this.state.shouldShowChatPlaceholder &&
                ...
                i.shouldShowChatPlaceholder || t.WebChatControlsUtils.setFocus());
            }),
            (r.prototype.render = function () {
              return React.createElement(
                'div',
                ...
                this.state.currentSurveyWidgetState !== t.WidgetState.Closed &&
                  React.createElement(t.SurveyPlaceholder, {
                    ...
                    hideEmailDialog: this.hideEmailDialog.bind(this),
                    showEmailRequestDialog: this.state.showEmailRequestDialog,
                ...
                this.state.showChat &&
                  React.createElement(
                    ...
                    React.createElement(t.ChatPlaceholder, {
                      ...
                      showHeader: !t.Bootstrapper.renderOnMobileDevice && !t.Bootstrapper.isPopOutMode,
                      hideEmailDialog: this.hideEmailDialog.bind(this),
                      showEmailRequestDialog: this.state.showEmailRequestDialog,
                      enabledActions: this.enabledActions
                    })
            ...
            (r.prototype.checkKeycode = function () {
              var n = this;
              t.Bootstrapper.isPopOutMode &&
                (window.addEventListener(t.HtmlEventNames.keydown, function (i) {
                  n.state.isRefresh =
                    i.keyCode == t.Constants.KeyCodes.KEY_F5 || (i.ctrlKey && i.keyCode == t.Constants.KeyCodes.KEY_R);
                }),
                window.addEventListener(t.HtmlEventNames.keyup, function (i) {
                  n.state.isRefresh =
                    i.keyCode == t.Constants.KeyCodes.KEY_F5 || (i.ctrlKey && i.keyCode == t.Constants.KeyCodes.KEY_R);
                }));
            }),
            (r.prototype.registerOnUnloadCallback = function () {
              ...
              window.addEventListener('beforeunload', function (t) {
                return n.handleOnBeforeUnload(t);
              });
              window.addEventListener('unload', function () {
                t.Bootstrapper.isPopOutMode
                  ? n.handleCloseSessionForPopOut()
                  : t.Loader.currentConversation.isChatComplete ||
                    t.Loader.currentConversation.sessionInitState !== t.SessionInitState.SessionInitComplete
                  ? n.closeConversation()
                  : n.cacheWidgetState();
              });
            }),
            (r.prototype.handleOnBeforeUnload = function (n) {
              t.Bootstrapper.isPopOutMode &&
                (window.navigator.userAgent.search(t.BrowserVendor.FIREFOX) > -1
                  ? this.handleCloseSessionForPopOut()
                  : (n.preventDefault(),
                    (n.returnValue = t.Loader.Locale.CLOSE_CONFIRMATION_POPOUT_WINDOW_DIALOG_DESCRIPTION)));
            }),
            (r.prototype.cacheWidgetState = function () {
              !t.Util.isNullOrUndefined(t.PopoutHandler.popOutWindowOpenRef) &&
                t.PopoutHandler.popOutWindowOpenRef.closed &&
                this.state.currentWidgetState === t.WidgetState.PopOutWindow &&
              ...
              t.ContextSpecificDataStore.UpsertData(
                ...
                t.ConfigurationManager.TokenRefreshTime
              );
            }),
            (r.prototype.isLoadWithState = function () {
              ...
              return (
                ...
                __awaiter(this, void 0, void 0, function () {
                  ...
                  return __generator(this, function (f) {
                    switch (f.label) {
                      case 0:
                        return !t.Bootstrapper.isPopOutMode && t.Loader.liveChatConfig.authClientFunction
                          ? [4, r.AcquireTokenFromStoreOrAuthMethod()]
                          : [3, 2];
                      case 1:
                        f.sent();
                        f.label = 2;
                      case 2:
                        return this.state.currentWidgetLoadingState === t.WidgetLoadingState.Complete
                          ? (t.TelemetryClient.info({ Event: t.TelemetryEvent.LCWChatButtonClicked }),
                            (u = n || this.isLoadWithState()),
                            (i = t.Util.timer()),
                            this.showComponents(t.Components.None),
                            !t.PopoutHandler.popOutWindowOpenRef)
                            ? [3, 3]
                            : (this.showChatButton(),
                              this.state.currentWidgetState !== t.WidgetState.PopOutWindow ||
                              t.PopoutHandler.popOutWindowOpenRef.closed
                                ? this.state.currentWidgetState === t.WidgetState.PopOutWindow &&
                                  t.PopoutHandler.popOutWindowOpenRef.closed &&
                                  (t.PopoutHandler.LoadWidgetInPopOutWindow(),
                                  this.changeCurrentWidgetState(t.WidgetState.PopOutWindow))
                                : t.PopoutHandler.popOutWindowOpenRef.focus(),
                              [3, 11])
                          : [3, 12];
                      case 3:
                        return t.Bootstrapper.openChatInPopOutWindow
                          ? (this.showChatButton(),
                            t.PopoutHandler.LoadWidgetInPopOutWindow(),
                            this.changeCurrentWidgetState(t.WidgetState.PopOutWindow),
                            [3, 11])
                          : [3, 4];
                      case 4:
                        return this.state.currentWidgetState === t.WidgetState.Minimized
                          ? (this.handleMaximize(), [3, 11])
                          : [3, 5];
                      case 5:
                        return this.prechatController.shouldRenderPrechat()
                          ? (this.showComponents(t.Components.PrechatSurvey),
                            ...
                            (this.fetchChatTokenPromise = t.Loader.fetchChatToken(!1)),
                            [3, 11])
                          : [3, 6];
                      case 6:
                        return this.postchatController.canRenderPostChat() &&
                          t.Loader.currentConversation.isPostChatDisplayed &&
                          !t.Bootstrapper.isPopOutMode
                          ? (this.props.liveChatConfig.postChatSurveyMode == t.MSFPSurveyMode.Embed
                              ? this.renderPostChatSurvey()
                      ...
                      case 7:
                        return !u
                          ? [
                              4,
                              this.loadWidget(!1).then(function () {
                      ...
                      case 11:
                        return [3, 14];
                      case 12:
                        return [4, this.startWidgetLoading()];
                      case 13:
                        f.sent();
                        f.label = 14;
                      case 14:
            ...
            (r.AcquireTokenFromStoreOrAuthMethod = function () {
              return __awaiter(this, void 0, void 0, function () {
                var u = this,
                  r,
                  i,
                ...
                return __generator(this, function (f) {
                  switch (f.label) {
                    case 0:
                      return ((r = t.ContextSpecificDataStore.GetData(
                        t.DataContextType.UserContext |
                          t.DataContextType.WidgetContext |
                          t.DataContextType.OrganizationContext,
                        t.WidgetDataKeys.AuthenticationToken
                      )),
                      !t.Util.isNullOrEmptyString(r))
                        ? [3, 3]
                        : ((this.authFunctionSucceeded = !1), (n = t.Loader.authTokenProvider), n)
                        ? [3, 2]
                        : [4, t.Util.getAuthTokenMethodFromString(t.Loader.liveChatConfig.authClientFunction, !0)];
                    case 1:
                      n = f.sent();
                      f.label = 2;
                    case 2:
                      if (((i = n), i))
                        try {
                          i(function (n) {
                            if (t.Util.isNullOrEmptyString(n)) {
                              var i = new Error('Received empty token');
                              t.LCWErrorTypes.raiseErrorEvent(
                                t.LCWErrorCode.LCW_AUTHTOKENPROVIDER_NO_TOKEN_RECEIVED,
                                i
                              );
                            } else (u.authFunctionSucceeded = !0), t.ContextSpecificDataStore.UpsertData(t.DataContextType.UserContext | t.DataContextType.WidgetContext | t.DataContextType.OrganizationContext, t.WidgetDataKeys.AuthenticationToken, n, t.ConfigurationManager.TokenRefreshTime);
                          });
                        } catch (e) {
                          t.TelemetryClient.info({
                          ...
                          t.LCWErrorTypes.raiseErrorEvent(t.LCWErrorCode.LCW_AUTHTOKENPROVIDER_METHOD_FAIL, e);
                          this.authFunctionSucceeded = !1;
                        }
                      else
                        t.TelemetryClient.info({
            ...
            (r.prototype.loadWidget = function (n) {
              var i = this;
              return this.startWidgetLoading()
                .then(function () {
                  return i.fetchChatTokenOrWaitCompleting(n);
                })
                .then(function () {
                  return i.resumeChat();
                })
                ...
                .then(function () {
                  return i.completeWidgetLoading(!1);
                })
                .catch(function (n) {
                  i.handleSessionInitError(n);
                  i.completeWidgetLoading(!0, n);
                  throw n;
                });
            }),
            (r.prototype.fetchChatTokenOrWaitCompleting = function (n) {
              return n ? this.fetchChatTokenPromise : t.Loader.fetchChatToken(!1);
            }),
                      ...
                      return !t.Loader.liveChatConfig.hideWidget
                        ? this.isLoadWithState()
                          ? ((n = t.ContextSpecificDataStore.GetData(
                            ...
                            [4, this.handleChatButtonClick(!0)])
                          : [3, 2]
                        : [3, 5];
                    case 1:
                      return i.sent(), [3, 5];
                    case 2:
                      return t.Bootstrapper.isPopOutMode ? [4, this.handleChatButtonClick(!1)] : [3, 4];
                    case 3:
                      return i.sent(), [3, 5];
                    case 4:
                      this.showChatButton();
            ...
            (r.prototype.showChatButton = function () {
              this.showComponents(t.Components.ChatButton);
            }),
            ...
            (r.prototype.loadWebChat = function () {
              return (
                (r.webChatProxy = new t.WebChat(this.props.liveChatConfig)),
                r.webChatProxy.createWebChat(),
                r.webChatProxy.registerOnNewMessageActivityCallback(this.onNewMessage.bind(this)),
                Promise.resolve()
              );
            }),
            (r.prototype.onNewMessage = function () {
              this.state.currentWidgetState === t.WidgetState.Minimized &&
                (this.setState({ unreadMessagesCount: this.state.unreadMessagesCount + 1 }),
                t.Utility.changeTitle(this.state.unreadMessagesCount));
            }),
            ...
            (r.prototype.closeConversation = function () {
              ...
              this.postchatController.setIsPostChatDisplayedState(!1);
            }),
            (r.prototype.resetConversationData = function () {
              t.ContextSpecificDataStore.RemoveData(
                t.DataContextType.UserContext | t.DataContextType.WidgetContext | t.DataContextType.OrganizationContext,
                t.WidgetDataKeys.ConversationData
              );
            }),
            ...
            (r.prototype.closeSession = function () {
              var n = this.postchatController.shouldRenderPostchat(),
                i;
              (!n || t.Bootstrapper.isPopOutMode) && t.Loader.IC3Adapter.end();
              t.Util.isNullOrUndefined(t.Loader.currentConversation.currentRequestId) ||
                ((i = t.Loader.currentConversation),
                t.Loader.sendSessionCloseEvent(i),
                !n || t.Bootstrapper.isPopOutMode
                  ? (this.closeConversation(), this.showComponents(t.Components.ChatButton))
                  : this.renderPostChatSurvey());
            }),
            (r.prototype.handleCloseSessionForPopOut = function () {
              this.state.isRefresh && !t.Loader.currentConversation.isChatComplete
                ? this.cacheWidgetState()
                : this.closeSession();
            }),
            (r.prototype.renderPostChatSurvey = function () {
              this.postchatController.setIsPostChatDisplayedState(!0);
              this.props.liveChatConfig.postChatSurveyMode == t.MSFPSurveyMode.Embed
                ? (this.showComponents(t.Components.PostchatSurvey),
                  this.setSurveyType(t.SurveyType.Postchat),
                  this.changeCurrentSurveyWidgetState(t.WidgetState.Maximized),
                  t.FrameHandler.setToDefaultSize(window))
                : t.Bootstrapper.isPopOutMode || this.showComponents(t.Components.ChatPlaceholder);
              this.cacheWidgetState();
              t.TelemetryClient.info({ Event: t.TelemetryEvent.PostchatWidgetLoaded });
            }),
            ...
            (r.prototype.changeCurrentSurveyWidgetState = function (n) {
              this.setState({ currentSurveyWidgetState: n });
            }),
            ...
            (r.prototype.showEmailDialog = function () {
              this.setState({ showEmailRequestDialog: !0 });
              var n = document.getElementById(t.HtmlIdNames.emailTranscriptDialogTextField);
              n != null && n.focus();
            }),
            (r.prototype.hideEmailDialog = function () {
              this.setState({ showEmailRequestDialog: !1 });
            }),
            (r.prototype.getEnabledActions = function () {
              var n = [];
              return (
                this.props.liveChatConfig &&
                  (this.props.liveChatConfig.isDownloadTranscriptEnabled &&
                    n.push(t.DownloadTranscriptAction.getDownloadTranscriptAction()),
                  this.props.liveChatConfig.isEmailTranscriptEnabled &&
                    n.push(t.EmailTranscriptAction.getEmailTranscriptAction(this.showEmailDialog.bind(this)))),
                n
              );
            }),
            ...
            (r.prototype.handleAgentEndConversation = function () {
              var n = this;
              this.postchatController.shouldRenderPostchat() &&
                setTimeout(function () {
                  return n.renderPostChatSurvey();
                }, t.Constants.postChatRenderTimeOnThreadUpdate);
            }),
      ...
      (function (n) {
        var t = (function (t) {
          function i(n) {
            ...
            return (i.state = { showCloseConfirmation: !1, closeConfirmationInput: {}, heightSet: !0 }), i;
          }
          return (
            __extends(i, t),
            (i.prototype.render = function () {
              return React.createElement(
                ...
                React.createElement(
                  'div',
                  {
                    ...
                    style: {
                      display:
                        this.props.showEmailRequestDialog || this.state.showCloseConfirmation
                          ? n.Constants.HTMLConstants.block
                          : n.Constants.HTMLConstants.none
                    }
                  },
                  this.props.showEmailRequestDialog &&
                    React.createElement(n.EmailRequestDialog, { onDialogHide: this.props.hideEmailDialog.bind(this) }),
                ...
                this.state.heightSet &&
                  React.createElement(n.WebChatRoot, {
                    actionBarActive: this.props.enabledActions.length > 0,
                    headerActive: this.props.showHeader
                  }),
                React.createElement(n.WebChatEventListener, null),
                this.props.enabledActions.length > 0 &&
                  React.createElement(n.ActionBar, { enabledActions: this.props.enabledActions })
              );
            }),
            (i.prototype.handleChatClose = function () {
              n.Util.isNullOrUndefined(n.Loader.currentConversation.chatId) ||
                (n.Utility.changeTitle(0),
                ...
                return __generator(this, function (t) {
                  switch (t.label) {
                    case 0:
                      return (
                        n.Util.isNullOrUndefined(n.Loader.currentConversation.chatId) ||
                          (n.Utility.changeTitle(0), this.props.showComponents(n.Components.ChatButton)),
            ...
            (i.prototype.confirmConversationClose = function () {
              for (
                var t = this.props.locale.CLOSE_CONFIRMATION_DIALOG_TITLE,
                  ...
                  u,
                  f = 0;
                f < this.props.enabledActions.length;
                f++
              )
                this.props.enabledActions[f].name == n.DefaultActions.DownloadTranscript
                  ? (u = !0)
                  : this.props.enabledActions[f].name == n.DefaultActions.EmailTranscript && (r = !0);
              r &&
                u &&
      ...
      var t = (function (t) {
        ...
        return (
          ...
          (i.prototype.keyHandlerRejectCall = function (t) {
            ((t.ctrlKey && t.shiftKey && t.keyCode === n.Constants.KeyCodes.KEY_D) ||
              t.keyCode === n.Constants.KeyCodes.KEY_ENTER) &&
              this.props.onCallReject();
          }),
          (i.prototype.keyHandlerAcceptVoiceCall = function (t) {
            ((t.ctrlKey && t.shiftKey && t.keyCode === n.Constants.KeyCodes.KEY_S) ||
              t.keyCode === n.Constants.KeyCodes.KEY_ENTER) &&
              this.props.onVoiceCallAccept();
          }),
          (i.prototype.keyHandlerAcceptVideoCall = function (t) {
            ((t.ctrlKey && t.shiftKey && t.keyCode === n.Constants.KeyCodes.KEY_A) ||
              t.keyCode === n.Constants.KeyCodes.KEY_ENTER) &&
              this.props.onVideoCallAccept();
          }),
          (i.prototype.keyHandlerToggleCamera = function (t) {
            ((t.ctrlKey && t.shiftKey && t.keyCode === n.Constants.KeyCodes.KEY_O) ||
              t.keyCode === n.Constants.KeyCodes.KEY_ENTER) &&
              this.props.onToggleLocalVideoClick();
          }),
          (i.prototype.keyHandlerToggleMute = function (t) {
            ((t.ctrlKey && t.shiftKey && t.keyCode === n.Constants.KeyCodes.KEY_M) ||
              t.keyCode === n.Constants.KeyCodes.KEY_ENTER) &&
              this.props.onToggleMuteClick();
          }),
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'div',
                    {
                      ...
                      style: { backgroundColor: n.Bootstrapper.widgetThemeColor }
                    },
                ...
                React.createElement(
                  ...
                  this.props.showCloseButton &&
                    React.createElement(
                      'div',
                      {
                        id: this.props.customCloseButtonId
                          ? this.props.customCloseButtonId
                          : n.HtmlIdNames.webChatHeaderCloseButton,
          ...
          return (
            ...
            (i.prototype.componentDidMount = function () {
              this.bindFunc(
                ...
                this.refs.chatRef.state.closeSession.bind(this),
                this.refs.chatRef.state.handleAgentEndConversation.bind(this)
              );
            }),
            (i.prototype.render = function () {
              var t = n.HtmlClassNames.chatRootReactClassName;
              return (
                n.Bootstrapper.renderOnMobileDevice
                  ? (t += ' ' + n.HtmlClassNames.inAppClassName)
                  : n.Bootstrapper.isPopOutMode && (t += ' ' + n.HtmlClassNames.popOutWindowClassName),
                React.createElement(
                  'div',
                  {
                    className: t,
            ...
            (i.prototype.bindFunc = function (n, t, r, u) {
              i.handleChatButtonClick = n;
              i.startProactiveChat = t;
              i.closeSession = r;
              i.handleAgentEndConversation = u;
            }),
            i
          );
        })(React.Component);
    ...
    (function (n) {
      ...
      (function (n) {
        var t = (function () {
          function t() {}
          return (
            (t.LoadWidgetInPopOutWindow = function () {
              var i, t;
              if (
                n.Util.isNullOrUndefined(n.Loader.liveChatConfig.authClientFunction) ||
                n.ChatContainer.authFunctionSucceeded
              ) {
                i = n.Bootstrapper.srcUrl.substring(0, n.Bootstrapper.srcUrl.indexOf('/script'));
                t = i.concat(
                  n.Constants.ChatHTMLPath,
                  n.Constants.EndURLSeparator,
                  n.Constants.URLDelimiter,
                  n.Constants.IdAttributeName,
                  n.Constants.Equal,
                  n.Constants.LiveChatScriptId,
                  n.Constants.URLDelimiter,
                  n.Constants.PopOutChatConstants.isPopOutModeAttributeName,
                  n.Constants.Equal,
                  n.Constants.PopOutChatConstants.isPopOutModeAttributeValue,
                  n.Constants.URLDelimiter,
                  n.Constants.AppIdAttributeName,
                  n.Constants.Equal,
                  n.Bootstrapper.widgetId,
                  n.Constants.URLDelimiter,
                  n.Constants.OrgIdAttributeName,
                  n.Constants.Equal,
                  n.Bootstrapper.orgId,
                  n.Constants.URLDelimiter,
                  n.Constants.OrgUrlAttributeName,
                  n.Constants.Equal,
                  n.Bootstrapper.orgUrl,
                  n.Constants.URLDelimiter,
                  n.Constants.DisableTelemetryAttributeName,
                  n.Constants.Equal,
                  n.Bootstrapper.disableTelemetry.toString()
                );
                n.Bootstrapper.widgetThemeColor &&
                  (t = t.concat(
                    n.Constants.URLDelimiter,
                    n.Constants.WidgetColorOverride,
                    n.Constants.Equal,
                    encodeURIComponent(n.Bootstrapper.widgetThemeColor)
                  ));
                var r = screen.availWidth * n.ConfigurationManager.popOutWindowWidthScaleFactor,
                  u = screen.availHeight * n.ConfigurationManager.popOutWindowHeightScaleFactor,
                  f = window.outerHeight / 2 + window.screenY - u / 2,
                  e = window.outerWidth / 2 + window.screenX - r / 2;
                this.popOutWindowOpenRef = window.open(
                  t,
                  n.Constants.PopOutChatConstants.target,
                  'width=' + r + ',height=' + u + ',location=no, top=' + f + ', left=' + e
                );
                this.setupCommunicationBetweenPopoutWindow(this.popOutWindowOpenRef);
              }
            }),
            (t.setupCommunicationBetweenPopoutWindow = function (t) {
              var i = this;
              t &&
                window.addEventListener(n.EventConstants.message, function (r) {
                  return __awaiter(i, void 0, void 0, function () {
                    var i;
                    return __generator(this, function (u) {
                      switch (u.label) {
                        case 0:
                          return r.data && r.data.messageName == n.IframeMessages.popoutAuthTokenRequest
                            ? [4, n.ChatContainer.AcquireTokenFromStoreOrAuthMethod()]
                            : [3, 2];
                        case 1:
                          u.sent();
                          i = n.ContextSpecificDataStore.GetData(
                            n.DataContextType.UserContext |
                              n.DataContextType.WidgetContext |
                              n.DataContextType.OrganizationContext,
                            n.WidgetDataKeys.AuthenticationToken
                          );
                          ...
                          t.postMessage({ messageName: n.IframeMessages.popoutAuthTokenResponse, authToken: i }, '*');
                          u.label = 2;
                        case 2:
                          return [2];
                      }
      ...
      (function (n) {
        var t = (function (t) {
          function i(r) {
            ...
            return (
              (u.state = {
                uuid: n.ToolTipUtils.generateUUID(),
                show: !1,
                delayHide: i.defaultDelayHide,
                event: r.event || null,
                originTooltip: null,
                offset: {},
                desiredPlace: i.defaultPosition,
                place: i.defaultPosition,
                currentTarget: null,
                currentEvent: null,
                ariaProps: n.Utility.getAriaAttributes(r)
              }),
              u.bindActions(['showTooltip', 'hideTooltip', 'mouseOnToolTip']),
              (u.delayHideLoop = null),
              (u.tooltipRef = null),
              u
            );
          }
          return (
            ...
            (i.prototype.render = function () {
              var u = this,
                ...
                e = t.ariaProps,
                o =
                  n.HtmlClassNames.toolTipBaseClass +
                  (' ' + f) +
                  (' ' + i.positionPrefix + this.state.place) +
                  (this.state.show && r ? ' ' + n.HtmlClassNames.toolTipShowClass : '');
              return React.createElement(
                'div',
                __assign(
                  {
                    id: this.props.id,
                    ref: function (n) {
                      return (u.tooltipRef = n);
                    },
                    'data-id': 'tooltip'
                  },
                  e,
                  { className: '' + o, onClick: 'event.preventDefault()' }
                ),
                r
              );
            }),
            ...
            (i.prototype.bindActions = function (n) {
              var t = this;
              n.forEach(function (n) {
                t[n].bind && (t[n] = t[n].bind(t));
              });
            }),
            (i.prototype.showTooltip = function (t) {
              var f = t.currentTarget.getAttribute(i.tooltipTitleAttribute),
                r = i.defaultPosition,
                u = n.ToolTipUtils.getPosition(t.currentTarget, this.tooltipRef, r, r, {}),
                e = u.isNewState ? u.newState.place : r;
              this.clearTimer();
              this.setState({
                delayHide:
                  t.currentTarget.getAttribute(i.dataDelayHideAttribute) || this.props.delayHide || i.defaultDelayHide,
                originTooltip: f,
                place: e,
            ...
            (i.prototype.hideTooltip = function (n, t) {
              var r = this,
                u = this.state,
                e = u.delayHide,
                h = u.originTooltip,
                ...
                s,
                f;
              (n.currentTarget !== i.lastTarget && i.lastTargetTooltipResetCallback(this),
              (i.lastTarget = n.currentTarget),
              !this.mouseOnToolTip() && h) &&
                (!t ||
                  ((o = this.getTargetArray(this.props.id)),
                  (s = o.some(function (t) {
                    return t === n.currentTarget;
                  })),
                  s && c)) &&
                ((f = function () {
                  if (r.mouseOnToolTip()) {
                ...
                this.clearTimer(),
                e ? (this.delayHideLoop = setTimeout(f, parseInt(e, 10))) : f());
            }),
            (i.prototype.forceHide = function () {
              this.removeListenerForTooltipExit();
              this.setState({ show: !1 });
            }),
            (i.prototype.bindListener = function () {
              var t = this,
                i = this.getTargetArray(this.props.targetId);
              i.forEach(function (n) {
                t.unbindBasicListener(n);
              });
              i.forEach(function (i) {
                i.addEventListener(n.HtmlEventNames.mouseenter, t.showTooltip);
                i.addEventListener(n.HtmlEventNames.mouseleave, t.hideTooltip);
              });
            }),
            (i.prototype.unbindListeners = function () {
              var n = this,
                t = this.getTargetArray(this.props.targetId);
              t.forEach(function (t) {
                n.unbindBasicListener(t);
              });
            }),
            (i.prototype.getTargetArray = function (n) {
              var u = this,
                t = [],
                i,
                r;
              if (n) (r = n.replace(/\\/g, '\\\\').replace(/"/g, '\\"')), (i = '[data-for="' + r + '"]');
              else return t;
              return (
                this.nodeListToArray(document.getElementsByTagName('*'))
                  .filter(function (n) {
                    return n.shadowRoot;
                  })
                  .forEach(function (n) {
                    t = t.concat(u.nodeListToArray(n.shadowRoot.querySelectorAll(i)));
                  }),
                t.concat(this.nodeListToArray(document.querySelectorAll(i)))
              );
            }),
            (i.prototype.nodeListToArray = function (n) {
              var t = n.length;
              return n.hasOwnProperty
                ? Array.prototype.slice.call(n)
                : new Array(t).map(function (t) {
                    return n[t];
                  });
            }),
            (i.prototype.unbindBasicListener = function (t) {
              t.removeEventListener(n.HtmlEventNames.mouseenter, this.showTooltip);
              t.removeEventListener(n.HtmlEventNames.mouseleave, this.hideTooltip);
            }),
            (i.prototype.clearTimer = function () {
              clearTimeout(this.delayHideLoop);
            }),
            (i.prototype.listenForTooltipExit = function () {
              var t = this.state.show;
              t && this.tooltipRef && this.tooltipRef.addEventListener(n.HtmlEventNames.mouseleave, this.hideTooltip);
            }),
            (i.prototype.removeListenerForTooltipExit = function () {
              var t = this.state.show;
              t &&
                this.tooltipRef &&
                this.tooltipRef.removeEventListener(n.HtmlEventNames.mouseleave, this.hideTooltip);
            }),
            (i.prototype.mouseOnToolTip = function () {
              ...
              return n && this.tooltipRef
                ? (this.tooltipRef.matches ||
                  ...
                  this.tooltipRef.matches(':' + i.hoverAttribute))
                : !1;
            }),
            (i.defaultPosition = 'top'),
            (i.positionPrefix = 'toolTipPlace-'),
            (i.tooltipTitleAttribute = 'tooltip-title'),
            (i.dataDelayHideAttribute = 'data-delay-hide'),
            (i.hoverAttribute = 'hover'),
            (i.defaultDelayHide = 0),
            (i.lastTarget = null),
            (i.lastTargetTooltipResetCallback = function (n) {
              n.forceHide();
            }),
            i
          );
    ...
    (function (n) {
      ...
      (function (n) {
        var t = (function () {
          function t() {}
          return (
            (t.getPosition = function (n, t, i, r, u) {
              for (
                var c,
                  e,
                  l,
                  a,
                  v = this.getDimensions(t),
                  ut = v.width,
                  ft = v.height,
                  y = this.getDimensions(n),
                  et = y.width,
                  ot = y.height,
                  p = this.getCurrentOffset(n),
                  w = p.mouseX,
                  b = p.mouseY,
                  f = this.getDefaultPosition(et, ot, ut, ft),
                  k = this.calculateOffset(u),
                  d = k.extraOffsetX,
                  g = k.extraOffsetY,
                  ...
                  o = function (n) {
                    return yt(n) || pt(n) || wt(n) || bt(n);
                  },
                  rt = function (n) {
                    return !o(n);
                  },
                  kt = ['top', 'bottom', 'left', 'right'],
                  s = [],
                  h = 0;
                h < 4;
                h++
              )
                (c = kt[h]), rt(c) && s.push(c);
              return ((e = !1),
              (a = r !== i),
              rt(r) && a ? ((e = !0), (l = r)) : s.length > 0 && a && o(r) && o(i) && ((e = !0), (l = s[0])),
              e)
                ? { isNewState: !0, newState: { place: l } }
                : {
                    isNewState: !1,
                    position: { left: parseInt(tt(i) - lt + '', 10), top: parseInt(it(i) - ct + '', 10) }
                  };
            }),
            (t.generateUUID = function () {
              return 't' + n.Utility.getGUID();
            }),
            (t.getDimensions = function (n) {
              var t = n.getBoundingClientRect(),
                i = t.height,
                r = t.width;
              return { height: parseInt(i, 10), width: parseInt(r, 10) };
            }),
            (t.getCurrentOffset = function (n) {
              var i = n.getBoundingClientRect(),
                ...
                e = r.width,
                o = r.height;
              return { mouseX: f + e / 2, mouseY: u + o / 2 };
            }),
            (t.getDefaultPosition = function (n, t, i, r) {
              var f,
                e,
                o,
                s,
                u = 2;
              return (
                (f = { l: -(i / 2), r: i / 2, t: -(t / 2 + r + u), b: -(t / 2) }),
                (o = { l: -(i / 2), r: i / 2, t: t / 2, b: t / 2 + r + u }),
                (s = { l: -(i + n / 2 + u), r: -(n / 2), t: -(r / 2), b: r / 2 }),
                (e = { l: n / 2, r: i + n / 2 + u, t: -(r / 2), b: r / 2 }),
                { top: f, bottom: o, left: s, right: e }
              );
            }),
            (t.calculateOffset = function (n) {
              var i = 0,
                r = 0,
                t;
              ...
              for (t in n)
                t === 'top'
                  ...
                  : t === 'left'
                  ? (i -= parseInt(n[t], 10))
                  : t === 'right' && (i += parseInt(n[t], 10));
              return { extraOffsetX: i, extraOffsetY: r };
            }),
            (t.getParent = function (n) {
              for (var t = n, i, r; t; ) {
                if (window.getComputedStyle(t).getPropertyValue('transform') !== 'none') break;
                t = t.parentElement;
              }
              return (
                (i = (t && t.getBoundingClientRect().top) || 0),
                (r = (t && t.getBoundingClientRect().left) || 0),
                { parentTop: i, parentLeft: r }
              );
            }),
            t
          );
    ...
    (function (n) {
      ...
      (function (n) {
        function t() {
          return function () {
            return function (t) {
              return function (r) {
                if (r.activity) {
                  if (r.activity.from && r.activity.from.role === n.DirectLineSenderRole.Channel)
                    return (
                      r.activity.channelData &&
                        r.activity.channelData.type &&
                        r.activity.channelData.type == n.Constants.MessageTypes.THREAD &&
                        i(r.activity.channelData),
                      function () {
                        return !1;
                      }
                    );
                  if (
                    n.Utility.isAdaptiveCard(r) &&
                    !n.Utility.isValidAdaptiveCard(r, n.Constants.supportedAdaptiveCardContentTypes)
                  )
                    return function () {
                      return !1;
                    };
        ...
        function i(t) {
          var i, u;
          if (
            (n.TelemetryClient.info({ Event: n.TelemetryEvent.IC3ThreadUpdateEvent }),
            t.members && t.members.length > 0)
          )
            for (i = 0; i < t.members.length; i++)
              if (((u = t.members[i].id), u.startsWith(n.WebChatMiddlewareConstants.visitorIdPrefix))) return;
          r();
          n.Loader.currentConversation.isChatComplete = !0;
          n.Util.raiseCustomEvent(n.LCWEvents.LCWThreadUpdateEvent);
          n.ChatRootReact.handleAgentEndConversation();
        }
        function r() {
          n.ChatContainer.webChatProxy.rerenderWebChat(!0);
        }
        function u(t, i) {
      ...
      (function (n) {
        ...
        var t = function (t) {
          ...
          u = function (t) {
            ...
            return React.createElement(
              'div',
              { className: n.HtmlClassNames.webChatAttachmentIcon, style: r },
        ...
        var t = (function (t) {
          ...
          return (
                  ...
                  try {
                    ...
                    switch (r) {
                      case n.HtmlEventNames.handleControlSlash:
                        n.WebChatControlsUtils.setFocus();
                    }
                  } catch (u) {
                    console.error(u);
                  }
            ...
            (i.prototype.handleKeydown = function (t) {
              t.ctrlKey && t.keyCode === n.Constants.KeyCodes.KEY_SLASH && n.WebChatControlsUtils.setFocus();
            }),
            (i.prototype.render = function () {
              return null;
            }),
    ...
    (function (n) {
      ...
      (function (n) {
        var s = (function () {
            function n() {}
            return (
              (n.popOutWindowClassName = 'pop-out'),
              (n.inAppClassName = 'inApp'),
              ...
              (n.webChatAttachmentIcon = 'oclcw-web-chat-attachment-icon'),
              ...
              (n.ppPostchatContainer = 'oclcw-pp-postchatcontainer'),
              ...
              (n.preChatDropdown = 'ac-input ac-multichoiceInput'),
              ...
              (n.toolTipBaseClass = 'toolTipBase'),
              (n.toolTipShowClass = 'toolTipShow'),
              n
            );
          })(),
          t,
        ...
        t = (function () {
          ...
          return (
            ...
            (n.webChatHeaderWelcomeCloseButton = 'webChatHeaderWelcomeCloseButton'),
            ...
            (n.postChatEmbedModeContainer = 'oclcwPostChatEmbedModeContainer'),
            n
          );
        })();
        n.HtmlIdNames = t;
            ...
            (i.prototype.componentDidMount = function () {
              this.props.welcomePageDisplayStyle.minimizeButtonVisibility
                ...
                : this.props.welcomePageDisplayStyle.closeButtonVisibility &&
                  n.Utility.focusOnElement(n.HtmlIdNames.webChatHeaderWelcomeCloseButton);
              n.FrameHandler.setToDefaultSize(window);
            }),
            (i.prototype.componentDidUpdate = function (t) {
              this.props.welcomePageDisplayStyle.closeButtonVisibility !==
                t.welcomePageDisplayStyle.closeButtonVisibility &&
                n.Utility.focusOnElement(n.HtmlIdNames.webChatHeaderWelcomeCloseButton);
            }),
            (i.prototype.render = function () {
              var t = this.props.liveChatConfig.chatButtonIconUrl ? this.props.liveChatConfig.chatButtonIconUrl : '',
              ...
              return React.createElement(
                ...
                React.createElement(
                  'div',
                  {
                    ...
                    'aria-live': n.HtmlClassNames.assertive
                  },
                  React.createElement(n.Header, {
                    liveChatConfig: this.props.liveChatConfig,
                    locale: this.props.locale,
                    ...
                    customCloseButtonId: n.HtmlIdNames.webChatHeaderWelcomeCloseButton
                  }),
                  React.createElement(
                    'div',
                    ...
                    React.createElement(
                      'div',
                      {
                        ...
                        style: {
                          display: this.props.welcomePageDisplayStyle.loadingComponentVisibility
                            ? n.Constants.HTMLConstants.block
                            : n.Constants.HTMLConstants.none
                        }
                      },
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'span',
                    {
                      role: n.HtmlAttributeNames.button,
                      tabIndex: 0,
                      className: n.HtmlClassNames.ipcpAcceptButtonText
                    },
              ...
              setTimeout(function () {
                try {
                  renderSurvey(
                    ...
                    '',
                    '',
                    t.props.liveChatConfig.chatWidgetLocale,
                    n.Loader.currentRequestId
                  );
                } catch (i) {
                  t.closePostchatView();
                  n.TelemetryClient.error({
                    Event: n.TelemetryEvent.PostChatFormsProRenderFailed,
                    ExceptionDetails: i
                  });
                }
              }, n.Constants.formsProEmbedSurveyLoadTime);
            }),
            (i.prototype.render = function () {
              return React.createElement(
                'div',
                ...
                React.createElement(
                  ...
                  React.createElement(
                    'div',
                    {
                      ...
                      className: n.HtmlClassNames.webChatDimLayer,
                      style: {
                        display: this.props.showEmailRequestDialog
                          ? n.Constants.HTMLConstants.block
                          : n.Constants.HTMLConstants.none
                      }
                    },
                  ...
                  React.createElement(
                    ...
                    React.createElement('div', {
                      id: n.HtmlIdNames.postChatEmbedModeContainer,
                      className: n.HtmlClassNames.ppPostchatContainer
                    })
                  )
                ),
                this.props.enabledActions.length > 0 &&
        ...
        var t = (function (t) {
          ...
          return (
            ...
            (i.prototype.componentDidMount = function () {
              ...
              var t = document.getElementsByClassName(n.HtmlClassNames.submitButton)[0];
              t && n.Bootstrapper.widgetThemeColor && (t.style.backgroundColor = n.Bootstrapper.widgetThemeColor);
            }),
            (i.prototype.render = function () {
              return React.createElement(
                'div',
                ...
                React.createElement(
                  ...
                  this.props.surveyType === n.SurveyType.Prechat &&
                    React.createElement(n.PrechatPage, {
                      ...
                      showHeader: !n.Bootstrapper.renderOnMobileDevice && !n.Bootstrapper.isPopOutMode
                    }),
                  this.props.surveyType === n.SurveyType.Postchat &&
                    React.createElement(n.PostchatPage, {
                      ...
                      hideEmailDialog: this.props.hideEmailDialog.bind(this),
                      showEmailRequestDialog: this.props.showEmailRequestDialog,
                      showHeader: !n.Bootstrapper.renderOnMobileDevice && !n.Bootstrapper.isPopOutMode
                    })
                )
              );
            ...
            (i.prototype.renderCard = function (t) {
              ...
              n.Utility.addScrollToPreChatDropdown(n.HtmlClassNames.preChatDropdown);
            }),
            i
          );
        })(React.Component);
          ...
          return (
            ...
            (i.prototype.onSurveySubmit = function (t) {
              if (this.props.validator.canSubmitSurvey(t)) {
                ...
                this.props.loadWidget(!0).then(function () {
        ...
        var t = (function () {
          ...
          return (
            (t.prototype.canRenderPostChat = function () {
              return this.config.isPostChatEnabled && n.Utility.isValidSurveyScript(n.Constants.msfpEmbedScript);
            }),
            (t.prototype.shouldRenderPostchat = function () {
              return (
                this.canRenderPostChat() &&
                !n.Loader.currentConversation.isPostChatDisplayed &&
                !n.Loader.currentConversation.isPostChatResponseSubmitted
              );
            }),
            (t.prototype.setIsPostChatDisplayedState = function (t) {
              n.Loader.currentConversation.isPostChatDisplayed = t;
            }),
            (t.prototype.addEmbedPostChatScriptToHead = function () {
              var f, s, u, e, o, r, i, t;
              if (
                n.Util.isNullOrUndefined(n.Constants.msfpEmbedScript) ||
                !n.Utility.isValidSurveyScript(n.Constants.msfpEmbedScript)
              ) {
                f = new Error(n.Constants.invalidMsfpEmbedScriptException);
                n.TelemetryClient.error({ Event: n.TelemetryEvent.PostChatFormsProRenderFailed, ExceptionDetails: f });
                throw f;
              }
              for (
                s = n.Constants.msfpEmbedScript.replace(
                  n.Constants.postChatSurveyIdentifierPlacement,
                  this.config.postChatSurveyIdentifier
                ),
                  u = document.createElement(n.Constants.HTMLConstants.div),
                  u.innerHTML = s,
                  e = u.getElementsByTagName(n.BootstrapperConstants.Script),
                  o = u.getElementsByTagName(n.BootstrapperConstants.Link),
                  r = 0;
                r < e.length;
                r++
              )
                (i = e[r]),
                  i.src &&
                    ...
                    (t.type = i.type),
                    (t.src = i.src),
                    window.document.head.contains(t) ||
                      document.getElementsByTagName(n.BootstrapperConstants.Head)[0].appendChild(t)),
                  i.innerHTML &&
                    ((t = document.createElement(n.BootstrapperConstants.Script)),
                    (t.innerHTML = i.innerHTML),
                    window.document.head.contains(t) || window.document.head.appendChild(t));
              for (r = 0; r < o.length; r++)
                (i = o[r]),
                  i.href &&
                    ((t = document.createElement(n.BootstrapperConstants.Link)),
                    (t.type = i.type),
                    (t.rel = i.rel),
                    (t.href = i.href),
                    window.document.head.contains(t) ||
                        ...
                        return t.Utility.validateIfSessionInitIsStartedOrComplete(this.currentConversation)
                          ...
                          : ((n = i.currentRequestId),
                            ...
                            (o = function () {
                              ...
                              var n = t.ConfigurationManager.TokenRefreshTime;
                              t.ContextSpecificDataStore.UpsertData(
                                t.DataContextType.UserContext |
                                  t.DataContextType.WidgetContext |
                                  t.DataContextType.OrganizationContext,
                              ...
                              i.currentConversation.isChatComplete = !1;
                              r();
                            }),
                            (s = function (n) {
                              !t.Util.isNullOrUndefined(n) &&
                                n.response.headers.errorcode &&
                                (i.currentConversation.sessionInitErrorCode = Number(n.response.headers.errorcode));
                              u(n);
                            }),
                          ...
                          ? [3, 2]
                          : [4, i.GetAuthenticationToken()];
                      case 1:
                        return (
                          (e = l.sent()),
                          t.Util.isNullOrEmptyString(e)
                            ? ((h = new Error('Received empty token')),
                              t.LCWErrorTypes.raiseErrorEvent(
                                t.LCWErrorCode.LCW_AUTHTOKENPROVIDER_NO_TOKEN_RECEIVED,
                                h
                              ))
                            : ((i.initContext.authenticatedUserToken = e), (f.authenticatedUserToken = e)),
                          (i.currentConversation.sessionInitState = t.SessionInitState.SessionInitStarted),
                          t.OmnichannelProxy.getInstance().sessionInit(n, f).then(o, s),
                          [3, 3]
                        );
                      case 2:
                        t.OmnichannelProxy.getInstance().sessionInit(n, f).then(o, s);
                        l.label = 3;
                      case 3:
                        return (i.currentConversation.isChatComplete = !1), [2];
                    }
                  });
                });
              });
            }),
            (i.GetAuthenticationToken = function () {
              return __awaiter(this, void 0, void 0, function () {
                var n;
                return __generator(this, function (i) {
                  switch (i.label) {
                    case 0:
                      return t.Bootstrapper.isPopOutMode && window.opener
                        ? ((n = t.Util.getAuthTokenOrAuthMethodFromOuterScope(
                            window.opener,
                            t.IframeMessages.popoutAuthTokenRequest,
                            null
                          )),
                          [3, 3])
                        : [3, 1];
                    case 1:
                      return [4, t.ChatContainer.AcquireTokenFromStoreOrAuthMethod()];
                    case 2:
                      i.sent();
                      n = t.ContextSpecificDataStore.GetData(
                        t.DataContextType.UserContext |
                    ...
                    switch (h.label) {
                      ...
                      case 1:
                        return (
                          (e = h.sent()),
                          t.Util.isNullOrEmptyString(e) &&
                            ((o = new Error('Received empty token')),
                            t.LCWErrorTypes.raiseErrorEvent(t.LCWErrorCode.LCW_AUTHTOKENPROVIDER_NO_TOKEN_RECEIVED, o)),
                  ...
                  return __generator(this, function (l) {
                    switch (l.label) {
                      ...
                      case 1:
                        return (
                          (s = l.sent()),
                          t.Util.isNullOrEmptyString(s)
                            ? ((c = new Error('Received empty token')),
                              t.LCWErrorTypes.raiseErrorEvent(
                                t.LCWErrorCode.LCW_AUTHTOKENPROVIDER_NO_TOKEN_RECEIVED,
                                c
                              ))
      ...
      (function (n) {
        var f = (function () {
            ...
            return (
              ...
              (n.DisableTelemetry = 'data-disable-telemetry'),
              (n.OpenChatInPopOutWindow = 'data-open-in-window'),
              (n.URLDelimiter = '&'),
              (n.EndURLSeparator = '?'),
              (n.ChatHTMLPath = '/htmls/chat.html'),
              (n.Equal = '='),
              (n.Class = 'class'),
              (n.Style = 'style'),
              (n.Link = 'link'),
              ...
              (n.Portal = 'Portal'),
              (n.User = 'User'),
              (n.ScriptBootstrapperPath = 'scripts/LiveChatBootstrapper.js'),
              (n.FrameStyleCssPath = 'WebChatControl/styles/LiveChatWidgetFrame.css'),
              n
            );
          })(),
          t,
        ...
        r = (function () {
          ...
          return (
            ...
            (n.LcwStartChat = 'lcw:startChat'),
            (n.LcwCloseChat = 'lcw:closeChat'),
            (n.LcwThreadUpdate = 'lcw:threadUpdate'),
            (n.LcwError = 'lcw:error'),
            (n.startChat = 'startChat'),
            (n.closeChat = 'closeChat'),
      ...
      (function (t) {
        var i = (function () {
          ...
          return (
            ...
            (i.prototype.initializeStyleSet = function (n) {
              n === void 0 && (n = !1);
            ...
            (i.prototype.initIC3Adapter = function () {
              var n = function (n) {
                n.id === t.NotificationScenarios.InternetConnection &&
                  n.level == t.NotificationLevel.Error &&
                  (n.message = t.Loader.Locale.BANNER_NO_INTERNET_CONNECTION);
                n.id === t.NotificationScenarios.InternetConnection &&
                  n.level == t.NotificationLevel.Success &&
                  (n.message = t.Loader.Locale.BANNER_INTERNET_BACK_ONLINE);
              ...
              this.ic3AdapterActivityCallbacks = [];
              this.SubsribeToIC3AdapterActivities();
            }),
            (i.prototype.SubsribeToIC3AdapterActivities = function () {
              t.Loader.IC3Adapter.activity$.subscribe(this.onNewIc3AdapterActivityHandler.bind(this));
            }),
            (i.prototype.onNewIc3AdapterActivityHandler = function (n) {
              console.log('onNewIc3AdapterActivityHandler', { n, callbacks: this.ic3AdapterActivityCallbacks });
              n.type === t.IC3AdapterActivityType.Message &&
                this.ic3AdapterActivityCallbacks[t.IC3AdapterActivityType.Message] &&
                this.ic3AdapterActivityCallbacks[t.IC3AdapterActivityType.Message].forEach(function (n) {
                  return n();
                });
            }),
            (i.prototype.registerOnNewMessageActivityCallback = function (n) {
              console.log('registerOnNewMessageActivityCallback', { n, callbacks: this.ic3AdapterActivityCallbacks });
              this.ic3AdapterActivityCallbacks[t.IC3AdapterActivityType.Message]
                ? this.ic3AdapterActivityCallbacks[t.IC3AdapterActivityType.Message].push(n)
                : (this.ic3AdapterActivityCallbacks[t.IC3AdapterActivityType.Message] = [n]);
            }),
            ...
            (i.prototype.rerenderWebChat = function (n) {
              this.initializeStyleSet(n);
              this.renderWebChat();
            }),
      ...
      (function (n) {
        var t = (function () {
          ...
          return (
            ...
            (t.isValidSurveyScript = function (t) {
              var i, r, u;
              return t &&
                ((i = document.createElement(n.Constants.HTMLConstants.div)),
                (i.innerHTML = t),
                (r = i.getElementsByTagName(n.BootstrapperConstants.Script)),
                (u = i.getElementsByTagName(n.BootstrapperConstants.Link)),
                !n.Util.isNullOrUndefined(r) && !n.Util.isNullOrUndefined(u) && r.length > 0 && u.length > 0)
                ? !0
                : !1;
            }),
            ...
            (t.getTimestampHourMinute = function (n) {
              ...
              return isNaN(t.getTime())
                ? ''
                : t.toLocaleTimeString(navigator.language, { hour: '2-digit', minute: '2-digit' });
            }),
            ...
            (t.addScrollToPreChatDropdown = function (t) {
              var i = document.getElementsByClassName(t)[0];
              n.Util.isNullOrUndefined(i) ||
                (i.setAttribute(
                  n.Constants.HTMLConstants.selectOnMouseDown,
                  'if(this.options.length>' +
                    n.Constants.HTMLConstants.preChatMaxDropdownSize +
                    '){this.size=' +
                    n.Constants.HTMLConstants.preChatMaxDropdownSize +
                    ';}'
                ),
                i.setAttribute(n.Constants.HTMLConstants.selectOnChange, 'this.size=0;'),
                i.setAttribute(n.Constants.HTMLConstants.selectOnBlur, 'this.size=0;'));
            }),
            ...
            (t.isValidAdaptiveCard = function (n, i) {
              var r, u, f;
              if (
                !t.isAdaptiveCard(n) ||
                ((r = n.activity.attachments), !r || !r.length || r.length <= 0 || !i || i.length <= 0)
              )
                return !1;
              for (u = 0; u < r.length; u++) if (((f = r[u].contentType), !f || i.indexOf(f) < 0)) return !1;
              return !0;
            }),
            (t.isAdaptiveCard = function (t) {
              var i, r, u;
              if (!t || !t.activity) return !1;
              if (((i = t.activity.attachments), i && i.length))
                for (r = 0; r < i.length; r++)
                  if (((u = i[r]), u.contentType && u.contentType.indexOf(n.Constants.applicationMicrosoftCard) > -1))
                    return !0;
              return !1;
            }),
            (t.getGUID = function () {
            ...
            (t.getAriaAttributes = function (n) {
              var t = {};
              return (
                Object.keys(n)
                  .filter(function (n) {
            ...
            (t.changeTitle = function (t) {
              n.Util.raiseCustomEvent(n.LCWEvents.LCWChangeTitle, t);
            }),
            t
          );
        })();
    ...
    (function (n) {
      ...
      (function (n) {
        ...
        (function (n) {
          ...
          n.Typing = 'typing';
          n.Event = 'event';
        })((t = n.IC3AdapterActivityType || (n.IC3AdapterActivityType = {})));
      })((t = n.LiveChatWidget || (n.LiveChatWidget = {})));
    })((t = n.Omnichannel || (n.Omnichannel = {})));
  })(Microsoft || (Microsoft = {}));
        ...
        var t = (function () {
          ...
          return (
            ...
            (t.prototype.startChat = function () {
              ...
              this.raiseLcwStartChatEvent();
            }),
            (t.prototype.closeChat = function () {
              n.TelemetryClient.info({ Event: n.TelemetryEvent.EndChatSDKCall });
              n.ChatRootReact.closeSession();
              this.raiseLcwCloseChatEvent();
            }),
            (t.prototype.startProactiveChat = function (t, i) {
              if (!n.Loader.liveChatConfig.isProactiveChatEnabled) {
            ...
            (t.prototype.raiseLcwStartChatEvent = function () {
              var t = this;
              n.Util.isNullOrUndefined(n.Loader.loaderPromise)
                ? setTimeout(function () {
                    return t.raiseLcwStartChatEvent();
                  }, n.ConfigurationManager.LoaderPromiseStateCheckInterval)
                : n.Loader.loaderPromise.then(function () {
                    n.Util.raiseCustomEvent(n.LCWEvents.LCWStartChatEvent);
                  });
            }),
            (t.prototype.raiseLcwCloseChatEvent = function () {
              var t = this;
              n.Util.isNullOrUndefined(n.Loader.loaderPromise)
                ? setTimeout(function () {
                    return t.raiseLcwCloseChatEvent();
                  }, n.ConfigurationManager.LoaderPromiseStateCheckInterval)
                : n.Loader.loaderPromise.then(function () {
                    n.Util.raiseCustomEvent(n.LCWEvents.LCWCloseChatEvent);
                  });
            }),
            t
          );
